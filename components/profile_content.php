        ...
        <div class="profile-wrapper">
            ...
            <span class="sidebar-col">
                ...
                <div class="sidebar-box">
                    ...
                    <?php foreach ($displayMedia as $row) { print "<img src='../users/". $sessionHandle ."/media/" .$row['content']. "'>"; } ?>
                </div>
            </span>
            ...
            <span class="posts-col">
                <div class="post-box">
                    <span class="user-frame">
                        <a href="#"><img class="avatar" src='../users/<?php echo $sessionHandle; ?>/<?php echo $sessionAvatar; ?>' /></a>
                    </span>
                    <span class="post-frame">
                        <h3>Nova publicação</h3>
                        <form id="newpost_box">
                            <textarea name="newpost-text" class="newpost_text" id="newpost_text"></textarea><br>
                            <a href="#"><input class="btn right" type="submit" value="Publicar" /></a>
                        </form>
                    <span>
                </div>
            ...
            <?php foreach ($displayPosts as $row) {
                    ...
                    echo    "<a href='#'><img class='avatar' src='../users/" . $sessionHandle . "/" . $sessionAvatar . "' /></a>";
                    echo "</span>";
                    ...
                    echo    "<h4 class='timestamp'>" . $sessionHandle . " &bull; " . time_elapsed_string($row['date']) . "</h4>";
                    echo    "<p>" . $row['text'] . "</p>";
                    echo "</span>";
                    echo "</div>";
                };
