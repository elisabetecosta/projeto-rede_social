    ...
    <div class="profile-content profile-info">
        <div class="profile-wrapper">
            ...
            <!-- Estatísticas do utilizador: número de posts, número de favoritos, número de pessoas que segue, número de seguidores -->
                <span class="stats-posts"><h3>Publicações</h3> <a href="#"><?php echo $posts; ?></a></span>
                <span class="stats-faves"><h3>Favoritos</h3> <a href="#"><?php echo $faves; ?></a></span>
                <span class="stats-following"><h3>Seguindo</h3> <a href="#"><?php echo $following; ?></a></span>
                <span class="stats-followers"><h3>Seguidores</h3> <a href="#"><?php echo $followers; ?></a></span>
            </span>
