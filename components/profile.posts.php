                ...
                <div class="fixed-box">
                    ...
                    <span class="post-frame">
                        ...
                        <div class='picturebox preview_media'>
                            <img id='preview' class='first' src="#" alt="Your image" />
                        </div>
                        ...
                        <div class="media_submit">
                            ...
                            <input id="uploaded_image" accept="image/png, image/jpg, image/gif, image/jpeg" type="file" onchange="previewMedia(this);"/>
                             <!--   
                             <label> 
