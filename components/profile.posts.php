            ...
            <span class="posts-col">
                <div class="fixed-box">
                    ...
                    <span class="post-frame">
                        ...
                        <form id="newpost_box" method="POST" action="../server/action.publish.php">
