        ...
        <div class="profile-wrapper">
            ...
            <span class="sidebar-col">
                ...
                <div class="sidebar-box">
                    ...
                    <?php foreach ($displayMedia as $row) { print "<img src='../users/". htmlentities($handle) ."/media/" . htmlentities($row['content']) . "'>"; } ?>
                </div>
            </span>
                    ...
                    foreach ($displayPosts as $row) {
                       ...
                       if(!empty($row['type'])){  
                            ...
                            if ($row['type'] == 'vid'){
                                ...
                                $video = convertYoutube($row['content']);
                            ...
                            //PICTURE - Se o conteúdo for imagens
                                ...
                                $displayImages = get_post_images($row['post_id']);

                                //Conta quantas imagens estão no array
                                $numImages = count($displayImages);

                                //Se for uma imagem
                                if ($numImages == 1) {
                                    foreach ($displayImages as $image) {
                                        echo "<div class='picturebox pics1'>";
                                        echo "<img class='first' src='../users/". $handle . "/media/" . $image['content'] . "'>";
                                        echo "</div>";
                                    }
                                //Se for duas imagens
                                } else if($numImages == 2){
                                    ...
                                    echo "<span>";
                                    echo "    <img class='first' src='../users/". $handle . "/media/" . $picture[0] . "'>";
                                    echo "</span>";
                                    echo "<span>";
                                    echo "    <img class='second' src='../users/". $handle . "/media/" . $picture[1] . "'>";
                                    echo " </span>";
                                    echo "</div>";
                                //Se for três imagens
                                } else if($numImages == 3){
                                    ...
                                    echo "<span>";
                                    echo "    <img class='second' src='../users/". $handle . "/media/" . $picture[1] . "'>";
                                    echo "    <img class='third' src='../users/". $handle . "/media/" . $picture[2] . "'>";
                                    echo " </span>";
                                    echo "</div>";
                                //Se for quatro imagens
                                    ...
                                    echo "<span>";
                                    echo "    <img class='third' src='../users/". $handle . "/media/" . $picture[2] . "'>";
                                    echo "    <img class='fourth' src='../users/". $handle . "/media/" . $picture[3] . "'>";
                                    echo "</span>";
                                    echo "</div>";
                                }
                            ...
                            //LINK - Se o conteúdo for um link
                                ...
                                echo "Inserir aqui o código que redirecciona para o link";
                            }
                        } 
                        /* echo $row['type']; */
