                ...
                if(empty($displayPosts)){
                    ...
                    foreach ($displayPosts as $row) {
                        ...
                        if(!empty($row['type'])){  
                            ...
                            if ($row['type'] == 'vid'){                                      //Se o post tiver imagens em anexo
                                echo "Video URL:" . $row['content'];
                            } else if($row['type'] == 'pic'){                                //Se o post tiver um vídeo
                                $displayImages = get_post_images($row['post_id']);
                                foreach ($displayImages as $image) {
                                echo "<img width='200px' src='../users/". $handle . "/media/" . $image['content'] . "'>";
                                }
                            } else if($row['type'] == 'txt'){        //Se o post partilhar um código 
                                echo "Inserir aqui o código que mostra o ficheiro.TXT";
                            } else if($row['type'] == 'lnk'){        //Se o post tiver um link 
