...
<!-- // POST-MODELO PARA AJUDAR A CRIAR O FOREACH ABAIXO // -->
                    ...
                    <span class='post-frame'>
                        ...
                        <input class='target' id='dropdown-menu' type='checkbox'>
                            ...
                            <span class="options dropdown-menu">
                                <input class='li' onclick="update()" type='button' data-id='140' value='Editar'>
                                <input class='li' onclick="update()" type='button' data-id='140' value='Afixar'>
                                <input class='li' onclick="update()" type='button' data-id='140' value='Copiar'>
                                <input class='li' onclick="update()" type='button' data-id='140' value='Eliminar'>
                            </span>
                        </span>
                        <h3>Teste</h3>
                        <h4 class='timestamp'> @rayana &bull; 3 segs</h4>
                        <p>Aqui temos um post com 4 imagens.</p>
                        <div class='picturebox pics4'>
                            <span>
                                <img class='first' src='../users/ana/media/gato.png'>
                                <img class='second' src='../users/ana/media/cavalo.png'>
                            </span>
                            <span>
                                <img class='third' src='../users/ana/media/ave.png'>
                                <img class='fourth' src='../users/ana/media/ave.png'>
                            </span>
                        </div>
                ...
                <div class='post-box'>
                    ...
                    <span class='post-frame'>
                        ...
                        <h3>Teste</h3>
                        <h4 class='timestamp'> @rayana &bull; 3 segs</h4>
                        <p>Aqui temos um post com uma imagem.</p>
                        <div class='picturebox pics1'>
                            <img class='first' src='../users/ana/media/gato.png'>
                        </div>
                        <div class='post-interaction'>
                            <span class='post-reply'><svg id='reply-icon' width='19.219' height='17.366' viewBox='0 0 5.085 4.595' xml:space='preserve' xmlns='http://www.w3.org/2000/svg'><path d='M4.134 4.827a1.447 1.447 0 0 1-.685-.321l-.126-.11-.577-.01a2.711 2.711 0 0 1-1.718-.527C.64 3.563.36 3.174.248 2.748-.034 1.658.813.564 2.149.294 2.506.22 3.18.238 3.519.328c.369.098.849.358 1.109.6.45.42.651.851.651 1.394 0 .534-.2.969-.633 1.38-.157.147-.211.222-.195.266.031.086.214.355.355.521.13.156.149.25.055.3-.097.05-.504.072-.727.038z' transform='translate(-.194 -.249)'/></svg> 4</span>
                ...
                <div class='post-box'>
                    ...
                    <span class='post-frame'>
                        ...
                        <h3>Teste</h3>
                        <h4 class='timestamp'> @rayana &bull; 3 segs</h4>
                        <p>Aqui temos um post com duas imagens.</p>
                        <div class='picturebox pics2'>
                            <span>
                                <img class="first" src="../users/ana/media/gato.png">
                            </span>
                            <span>
                                <img class="second" src="../users/ana/media/gato.png">
                            </span>
                        </div>
                        <div class='post-interaction'>
                            <span class='post-reply'><svg id='reply-icon' width='19.219' height='17.366' viewBox='0 0 5.085 4.595' xml:space='preserve' xmlns='http://www.w3.org/2000/svg'><path d='M4.134 4.827a1.447 1.447 0 0 1-.685-.321l-.126-.11-.577-.01a2.711 2.711 0 0 1-1.718-.527C.64 3.563.36 3.174.248 2.748-.034 1.658.813.564 2.149.294 2.506.22 3.18.238 3.519.328c.369.098.849.358 1.109.6.45.42.651.851.651 1.394 0 .534-.2.969-.633 1.38-.157.147-.211.222-.195.266.031.086.214.355.355.521.13.156.149.25.055.3-.097.05-.504.072-.727.038z' transform='translate(-.194 -.249)'/></svg> 4</span>
                ...
                <div class='post-box'>
                    ...
                    <span class='post-frame'>
                        ...
                        <h3>Teste</h3>
                        <h4 class='timestamp'> @rayana &bull; 3 segs</h4>
                        <p>Aqui temos um post com três imagens.</p>
                        <div class='picturebox pics3'>
                            <span>
                                <img class='first' src='../users/ana/media/gato.png'>
                            </span>
                            <span>
            ...
            <?php
                $a = 1; //Para ligar cada label à sua respectiva checkbox (dropdown-menu1, dropdown-menu2, dropdown-menu3...)
                if(empty($displayPosts)){
                    ...
                    foreach ($displayPosts as $row) {
                        ...
                        echo        "<input class='target' id='dropdown-menu". $a ."' type='checkbox'>";
                        echo        "<label onclick='dropdown()' class='btn-dropdown-menu right' for='dropdown-menu". $a ."'><svg width='4.856' height='20.892' viewBox='0 0 1.285 5.528' xml:space='preserve' xmlns='http://www.w3.org/2000/svg'><path style='fill:#808a99;fill-opacity:1;stroke-width:.0672245;stroke-linecap:round;stroke-linejoin:round;paint-order:stroke markers fill' d='M1.285.642a.642.642 0 0 1-.643.643A.642.642 0 0 1 0 .642.642.642 0 0 1 .642 0a.642.642 0 0 1 .643.642zM1.285 2.764a.642.642 0 0 1-.643.642A.642.642 0 0 1 0 2.764a.642.642 0 0 1 .642-.643.642.642 0 0 1 .643.643zM1.285 4.885a.642.642 0 0 1-.643.643A.642.642 0 0 1 0 4.885a.642.642 0 0 1 .642-.642.642.642 0 0 1 .643.642z'/></svg></label>";
                        ...
                        echo    "<p>" . $row['text'] . "</p>";
                        echo $row['post_id'];
                        //Verifica se o post tem conteúdo na tabela "média". Se tiver, vai imprimir:
                        if(!empty($row['type'])){  
                            ...
                            //CODE - Se o conteúdo for código
                                ...
                                echo "Inserir aqui o código que mostra o ficheiro.TXT";
                    ...
                    // Nesta instância, $a tem valor 11;
                };
            ?>
            </span>
        </div>
