...
<header> 
    <nav class="navbar">
        <section> <!-- Esta <section> aqui é a navbar:firstchild que permite indentar o logotipo  -->
            <a href="../<?=$_SESSION['handle']?>/<?=$userSettings->homeURL; ?>">
                <img src="../images/logo.svg" alt="logo" id="logo">
            </a>
        </section>
        <div> <!-- Esta <div> aqui está a segurar os links de navegação à direita. Parent: <nav>.  -->
            <span class="search">
                <input placeholder="Procuras alguma coisa?" type="text" >
