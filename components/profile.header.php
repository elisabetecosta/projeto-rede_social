<main class="profile-container">
    ...
    <div class="profile-content profile-info">
        <div class="profile-wrapper">
            ...
            <a <?php echo $focusposts ?> href="../server/posts.php"><h3>Publicações</h3><span><?php echo "{$userProfile->userData['posts']}"; ?></span></a>
            <a <?php echo $focusfave ?> href="../server/favorites.php"><h3>Favoritos</h3><span><?php echo "{$userProfile->userData['faves']}"; ?></span></a>
            <a <?php echo $focusflwing ?> href="../server/following.php"><h3>Seguindo</h3><span><?php echo "{$userProfile->userData['following']}"; ?></span></a>
            <a <?php echo $focusflwers ?> href="../server/followers.php"><h3>Seguidores</h3><span><?php echo "{$userProfile->userData['followers']}"; ?></span></a>
            </span>
