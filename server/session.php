...
class Settings {
    ...
    var $homeURL = "posts";                         // posts.php - link do logotipo XATA
    var $profileURL = "posts";                      // posts.php - link do avatar do user (avatar pequenino)
    var $notifsURL = "notifications";               // notifications.php - link do icone de notificações (sineta)
    var $configURL = "settings";                    // settings.php - link do ícone de configurações (roda dentada)
    var $logoutURL = "logout";                      // logout.php - link do botão de logout
